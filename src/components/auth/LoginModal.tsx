        ...
        <div className="border-4 border-white p-6 bg-black shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
          ...
          <div className="flex flex-col gap-6">
            <form action={formAction} className="flex flex-col gap-6">
              ...
              <button
                type="submit"
                className="mt-4 bg-white text-black font-mono font-bold py-3 uppercase tracking-widest hover:bg-neutral-300 active:translate-y-1 transition-all border-b-4 border-neutral-500 active:border-b-0"
              >
              ...
              {view === 'forgot' && (
                <button
                  ...
                  className="text-center text-xs text-neutral-400 hover:text-white uppercase font-mono"
                >
                  Back to Login
                </button>
              )}
            ...
            {view === 'login' && (
              <>
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-3 bg-transparent border-2 border-white text-white font-mono font-bold py-3 uppercase tracking-widest hover:bg-white hover:text-black transition-all active:translate-y-1"
                >
